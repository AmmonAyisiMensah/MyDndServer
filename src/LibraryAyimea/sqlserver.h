...
/**
 * @brief Interface with basic functionality for an Microsoft SQL Server database
 * The Interface functionality is used by the CRUD API
 * @see CRUD_API
 * @see CRUD_Interface
 */
class AYIMEA_EXPORT SqlServer : public CRUD_Interface
{
public:
    /**
     ...
     */
    SqlServer(SQL_Connection *connection);
